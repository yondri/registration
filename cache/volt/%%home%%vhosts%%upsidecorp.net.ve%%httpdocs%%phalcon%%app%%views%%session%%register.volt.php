...
<div class="page-header">
    <h2>Register for EasyTasks</h2>
</div>

<?php echo Phalcon\Tag::form(array('session/register', 'id' => 'registerForm', 'class' => 'form-horizontal', 'onbeforesubmit' => 'return false')); ?>
    <fieldset>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo Phalcon\Tag::textField(array('username', 'class' => 'input-xlarge')); ?>
                <p class="help-block">(required)</p>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo Phalcon\Tag::passwordField(array('password', 'class' => 'input-xlarge')); ?>
        ...
        <div class="form-actions">
            <?php echo Phalcon\Tag::submitButton(array('Register', 'class' => 'btn btn-primary btn-large', 'onclick' => 'return SignUp.validate();')); ?>
            <?php echo Phalcon\Tag::linkTo(array('index/index', 'Cancel', 'class' => 'btn btn-large')); ?>
        </div>
    </fieldset>
</form>
